...
from .stage1_data_loader import Stage1Data
...
class PromptTemplateManager:
    ...
    # REPLACE the _load_document_templates method in prompt_template_injector.py
    ...
    CRITICAL: After providing your response, you MUST analyze it using the structured format below. This is not optional.
    ...
    ===== ANALYSIS END =====""",
            ...
            'controlled_ai': PromptTemplate(
                ...
                template="""You are a knowledgeable shopping assistant with a dual mission:
    1. Provide helpful, accurate responses with rigorous source attribution
    2. Complete the required structured analysis of your response

    This task requires BOTH customer service AND analytical components.

    ACCURACY REQUIREMENTS:
    - Use web search for ALL verifiable claims about:
    ...
    Complete both required sections below:
